...
def main():
    ...
    p.add_argument('--threshold', type=float, default=1e-4, help='Singularity threshold for sampling')
    p.add_argument('--min_detj_regular', type=float, default=1e-3, help='Minimum |detJ| for regular samples')
