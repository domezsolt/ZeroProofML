...
from zeroproof.bridge import (
    from_ieee, to_ieee,
    Precision, PrecisionContext, with_precision,
    analyze_precision_requirements, get_precision_info,
    NUMPY_AVAILABLE, TORCH_AVAILABLE, JAX_AVAILABLE
)
...
def demonstrate_numpy_bridge():
    ...
    import numpy as np
    from zeroproof.bridge import from_numpy, to_numpy, TRArray, count_tags
...
def demonstrate_jax_bridge():
    ...
    from zeroproof.bridge import (
        from_jax, to_jax, TRJaxArray,
        tr_add_jax, tr_mul_jax
    )
