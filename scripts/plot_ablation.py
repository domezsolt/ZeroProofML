...
def plot_bucket_bars(mask_dir: str, hybrid_dir: str, outdir: str, fname: str = 'e2_ablation_buckets.png') -> str:
    try:
...
def plot_ple_trajectory(mask_dir: str, hybrid_dir: str, outdir: str, fname: str = 'e2_ple_history.png') -> str:
    try:
        import matplotlib.pyplot as plt
        import numpy as np
    except Exception as e:
...
def main():
    ...
    ap.add_argument('--outdir', default='results/robotics/figures', help='Output directory for figures')
    args = ap.parse_args()
