...
def create_figure1_nearpole_bars():
    ...
    ax.annotate(f'{pct_b0:.1f}%↓', xy=(0, b0_values[0]), xytext=(0, b0_values[0] + y_offset),
                fontsize=8, color='darkgreen', weight='bold', ha='center',
                arrowprops=dict(arrowstyle='->', color='darkgreen', lw=1))
    ax.annotate(f'{pct_b1:.1f}%↓', xy=(0, b1_values[0]), xytext=(0, b1_values[0] + y_offset*0.7),
                fontsize=8, color='darkgreen', weight='bold', ha='center',
                arrowprops=dict(arrowstyle='->', color='darkgreen', lw=1))
...
def create_figure3_ablation():
    ...
    ax3.text(2, rollout_full + 0.2, f'{imp_rollout:.1f}% ↓', ha='center', fontsize=8, 
