...
from ..core import (
    ...
    tr_neg as core_neg,
    tr_abs as core_abs,
    tr_sign as core_sign,
    tr_log as core_log,
    tr_sqrt as core_sqrt,
    tr_pow_int as core_pow_int,
)
from .tr_node import TRNode, GradientInfo, OpType
...
def _create_result_node(value: TRScalar,
                       op_type: OpType,
                       inputs: list[TRNode],
                       extra_data: Optional[dict] = None) -> TRNode:
