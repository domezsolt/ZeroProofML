...
def backward_pass(root: TRNode, 
                  grad_output: Optional[TRScalar] = None,
                  sources: Optional[Set[TRNode]] = None) -> None:
    """
...
def compute_input_gradients(node: TRNode, grad_output: TRScalar) -> List[Optional[TRScalar]]:
    ...
    """
    from ..core import tr_mul, tr_div, tr_neg, tr_sqrt, tr_pow_int
