...
class StructuredLogger:
    ...
    def log_gradient_info(self, 
                         gradient_mode: str,
                         delta: Optional[float] = None,
                         saturating_ratio: Optional[float] = None) -> Dict[str, Any]:
        """
...
class ExperimentTracker:
    ...
    def start_experiment(self, 
                        name: str,
                        config: Dict[str, Any],
                        model_info: Dict[str, Any]) -> StructuredLogger:
        """
...
def log_training_step(logger: StructuredLogger,
                     epoch: int,
                     step: int,
                     loss: float,
                     tags: List[TRTag],
