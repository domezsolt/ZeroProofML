...
from zeroproof.utils.optimization import (
    TROptimizer, GraphOptimizer, OperationFuser, MemoryOptimizer,
    OptimizationConfig, optimize_tr_graph, analyze_memory_usage
)
...
class TestOptimizer:
    ...
    def test_common_subexpression_elimination(self, values):
        ...
        assert stats.get('cse_eliminated', 0) >= 0  # May or may not eliminate depending on implementation
