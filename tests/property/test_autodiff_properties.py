...
from zeroproof.autodiff import TRNode, gradient_tape, tr_grad, tr_mul, tr_add


# Strategies for generating test data
finite_reals = st.floats(min_value=-100.0, max_value=100.0, 
                        allow_nan=False, allow_infinity=False,
                        allow_subnormal=False)

small_positive_reals = st.floats(min_value=0.1, max_value=10.0)

safe_reals = st.floats(min_value=-10.0, max_value=10.0,
                      allow_nan=False, allow_infinity=False)
