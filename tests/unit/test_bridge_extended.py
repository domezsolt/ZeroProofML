...
from zeroproof.bridge import from_ieee, to_ieee, Precision, PrecisionContext, with_precision
...
class TestNumpyBridge:
    ...
    def test_numpy_tag_counting(self):
        ...
        import numpy as np
        from zeroproof.bridge import from_numpy, count_tags
...
class TestPyTorchBridge:
    ...
    def test_torch_device_handling(self):
        ...
        import torch
        from zeroproof.bridge import from_torch, TRTensor
...
class TestJAXBridge:
    ...
    def test_jax_array_conversion(self):
        ...
        from zeroproof.bridge import from_jax, to_jax, TRJaxArray
