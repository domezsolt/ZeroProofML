...
def test_bucketed_mse_schema(tmp_path):
    ...
    res = run_zeroproof_baseline((train_inputs, train_targets), (test_inputs, test_targets),
                                 enable_enhancements=False, output_dir=str(tmp_path), test_detJ=test_detj,
                                 bucket_edges=edges, epochs=1)
