...
from zeroproof.autodiff import GradientMode, TRNode, backward_pass
from zeroproof.core import TRTag, ninf, phi, pinf, real, tr_add, tr_div, tr_mul
...
class TestHybridGradientSchedule:
    ...
    def test_mask_real_mode(self):
        ...
        schedule = HybridGradientSchedule(
            warmup_epochs=0, transition_epochs=0, delta_init=0.01, enable=True
        )
    ...
    def test_saturating_grad_mode(self):
        ...
        schedule = HybridGradientSchedule(
            warmup_epochs=0, transition_epochs=20, delta_init=0.01, saturating_bound=100.0
        )
    ...
    def test_hybrid_schedule_transition(self):
        ...
        schedule = HybridGradientSchedule(
            warmup_epochs=10, transition_epochs=20, delta_init=0.01, delta_final=1e-6, enable=True
        )
