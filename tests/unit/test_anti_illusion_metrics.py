...
class TestSignConsistencyChecker:
    ...
    def test_simple_crossing(self):
        ...
        metrics = checker.check_path_crossing(
            model, path_func, (-0.5, 0.5), pole_t=0.0
        )
...
class TestAsymptoticSlopeAnalyzer:
    ...
    def test_simple_pole_slope(self):
        ...
        metrics = analyzer.compute_asymptotic_slope(
            model, pole_location=0.5, window_size=0.2
        )
    ...
    def test_double_pole_slope(self):
        ...
        metrics = analyzer.compute_asymptotic_slope(
            model, pole_location=0.5, window_size=0.1
        )
...
class TestAntiIllusionMetrics:
    ...
    def test_evaluate_model(self):
        ...
        results = metrics.evaluate_model(
            model, ground_truth, x_range=(-2, 2)
        )
